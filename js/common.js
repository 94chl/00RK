      ...
      $.getJSON("../json/area.json", function (data) {
        ...
        function showDA() {
          ...
          $(cleanDA).each(function() {
            $("#area .area#"+(this).area+" .drops").append("<span class='dropM "+(this).drops+"'>"+getById((this).drops,drop).name+"<span class='mNumber'>(x"+(this).count+")</span></span>")
          })
        ...
        $(".checkboxE").on("change", function() {
          $(".materials .selectedAll span").css("color","black")
          $("#area .area .drops span").css("color","black")
          let checkedE = [];
          ...
          for(i=0; i<checkedE.length; i++) {
            for(o=0; o<checkedE[i].drops.length; o++){
              $(".materials .selectedAll ."+checkedE[i].drops[o]).css("color","red")
              $("#area .area .drops ."+checkedE[i].drops[o]).css("color","red")
            }
          }
        })
        ...
        $(".checkboxA").on("change", function() {
          $(".materials .selectedAll span").css("text-decoration","none")
          $("#area .area .drops span").css("text-decoration","none")
          let checkedA = [];
          ...
          console.log(checkedAM)
          for(u=0; u<checkedAM.length; u++) {
            $(".materials .selectedAll ."+checkedAM[u]).css("text-decoration","line-through")
            $("#area .area .drops ."+checkedAM[u]).css("text-decoration","line-through")
          }
        })
